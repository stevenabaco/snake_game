document.addEventListener('DOMContentLoaded', () => {
	...
	const leftBtn = document.getElementById('move_left');
	const upBtn = document.getElementById('move_up');
	const rightBtn = document.getElementById('move_right');
	const downBtn = document.getElementById('move_down');
	...
	function moveOutcomes() {
		...
		const tail = currentSnake.pop(); //removes las item of the array and shows it
	...
	function control(e) {
		...
		if (e.keyCode === 39) {
			direction = 1; //if we press the right arrow on our keyboard, the snake will move go right one
